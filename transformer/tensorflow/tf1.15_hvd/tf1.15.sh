...
python3 --version
# python3 transformer.py --train data/retrosynthesis-train-valid.smi --run_name 1gpu_no_hvd
# python3 transformer.py --validate data/retrosynthesis-test.smi --model output/run_20200821T154406/final.h5 --beam 5 --run_name validate2
